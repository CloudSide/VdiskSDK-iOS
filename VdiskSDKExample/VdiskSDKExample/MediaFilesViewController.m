...
@interface MediaFilesViewControllerViewController () <VdiskRestClientDelegate> {
...
@implementation MediaFilesViewControllerViewController
...
- (IBAction)onLoadFileButtonPressed:(id)sender {
    ...
    [_vdiskRestClient loadStreamableURLForFile:_filePathTextField.text];
...
- (void)restClient:(VdiskRestClient *)client loadStreamableURLFailedWithError:(NSError *)error {
...
- (void)restClient:(VdiskRestClient *)client loadedStreamableURL:(NSURL *)url forFile:(NSString *)path {
